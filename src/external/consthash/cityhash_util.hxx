...
constexpr uint64_t HashLen0to16_ge_8_sub(const char*, size_t, uint64_t mul, uint64_t a, uint64_t b) {
...
constexpr uint64_t HashLen33to64_sub3(const char *, size_t, uint64_t mul,
                                    uint64_t, uint64_t b, uint64_t, uint64_t d,
                                    uint64_t, uint64_t, uint64_t, uint64_t h,
                                    uint64_t, uint64_t y, uint64_t x, uint64_t z) {
